...
from lft.consensus.events import ReceivedDataEvent, StartRoundEvent, ReceivedVoteEvent
...
@pytest.mark.asyncio
async def test_change_by_future_data():
    order_layer, sync_layer, voters, event_system = await setup_order_layer()


@pytest.mark.asyncio
async def test_change_by_future_vote():
    order_layer, sync_layer, voters, event_system = await setup_order_layer()
